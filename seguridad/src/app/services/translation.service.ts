  ...
  private translations = {
    'Español': {
      ...
      alertas: {
        ...
        alertTypeOptions: ['Robo / Hurto', 'Vandalismo', 'Rondín', 'Incendio', 'Falla técnica', 'Actividad sospechosa', 'Otro', 'Incidente', 'Novedad'],
    ...
    'English': {
      ...
      alertas: {
        ...
        alertTypeOptions: ['Robbery / Theft', 'Vandalism', 'Patrol', 'Fire', 'Technical Failure', 'Suspicious Activity', 'Other', 'Incident', 'Novelty'],
