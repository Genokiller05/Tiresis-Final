...
CREATE TABLE public.guards (
  idEmpleado text NOT NULL UNIQUE,
  nombre text,
  email text,
  area text,
  estado text,
...
CREATE TABLE public.reports (
  ...
  CONSTRAINT reports_created_by_guard_id_fkey FOREIGN KEY (created_by_guard_id) REFERENCES public.guards(id)
);
